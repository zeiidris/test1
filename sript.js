...
const text = ( /Android|webOS|iPhone|iPad|iPod|Opera Mini/i.test(navigator.userAgent) )?`Your character in this game is <img src="1.png">. You have to put all of yellow boxes <img src="2.png"> on the red dots <img src="3.png">. You can push yellow boxes and you CANNOT pull it. if box is on a dot, it becomes green. Swipe right to move your character to right, left to move to the left, up to move up, down to move down.
There are three levels in this game that differ in difficulity and that you cannot finish it.`: `Your character in this game is <img src="1.png">. You have to put all of yellow boxes <img src="2.png"> on the red dots <img src="3.png">. You can push yellow boxes and you CANNOT pull it. if box is on a dot, it becomes green. Use → to move your character to right, ← to move to the left, ↑ to move up, ↓ to move down.
